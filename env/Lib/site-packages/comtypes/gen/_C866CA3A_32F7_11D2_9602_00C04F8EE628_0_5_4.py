...
__all__ = [
    'SPSNoun', 'SPAR_High', 'DISPID_SPRDisplayAttributes',
    'SPDKL_CurrentUser', 'SGSDisabled', 'SVEStartInputStream',
    'SAFT11kHz8BitStereo', 'DISPID_SPRuleFirstElement', 'SVPOver',
    ...
    'STSF_CommonAppData', 'ISpShortcut', 'SSSPTRelativeToStart',
    'DISPID_SPEsCount', 'SPSVerb', 'DISPID_SDKGetStringValue',
    'ISpeechMMSysAudio', 'SDTLexicalForm', 'SRERecognition',
    'SPWORDLIST', 'ISpeechRecognizerStatus', 'SpeechAddRemoveWord',
    'SPDATAKEYLOCATION', 'DISPID_SPEPronunciation',
    'SAFT24kHz8BitMono', 'SPVPRI_NORMAL', 'DISPID_SPPsItem',
    'ISpStream', 'SPPHRASERULE', 'SLODynamic',
    'SpeechEngineProperties', 'SPRST_INACTIVE_WITH_PURGE',
    'SPRST_ACTIVE', 'SRADynamic', 'DISPID_SpeechRecognizer',
    'SPFM_CREATE_ALWAYS', 'DISPID_SGRId', 'SPSERIALIZEDPHRASE',
    'DISPID_SPIGrammarId', 'eLEXTYPE_LETTERTOSOUND', 'SPGS_EXCLUSIVE',
    'SpVoice', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SRCCmdMaxAlternates', 'SGDSActive', 'eLEXTYPE_RESERVED9',
    'SPVPRI_OVER', 'DISPID_SRCResume', 'SpeechRegistryUserRoot',
    'DISPID_SDKOpenKey', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SVVoice', 'SGPronounciation', 'SAFTCCITT_ALaw_11kHzMono',
    'SPCONTEXTSTATE', 'SREPhraseStart', 'DISPID_SOTRemove',
    'DISPID_SRRGetXMLResult', 'SPPHRASEELEMENT', 'DISPID_SRGetFormat',
    'SP_VISEME_14', 'SGSEnabled', 'eLEXTYPE_PRIVATE7',
    'SVEWordBoundary', 'DISPID_SLWWord', 'DISPID_SOTDisplayUI',
    'SPBO_TIME_UNITS', 'eLEXTYPE_PRIVATE14', 'SECNormalConfidence',
    'SVEAllEvents', 'SVSFIsNotXML', 'DISPID_SOTGetDescription',
    'SpLexicon', 'SPEI_INTERFERENCE', 'DISPID_SPPChildren',
    'SPBO_PAUSE', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SDKDeleteKey', 'SPVISEMES', 'SpeechAudioFormatGUIDWave',
    'DISPID_SpeechPhoneConverter', 'ISpRecoCategory',
    'DISPID_SABIBufferSize', 'SAFT11kHz16BitMono',
    'SECFEmulateResult', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SVAudioOutputStream', 'DISPID_SRCERecognition',
    'DISPID_SLPsCount', 'SPBO_NONE',
    'DISPID_SRCEPropertyStringChange', 'SGDSInactive',
    'DISPID_SpeechAudioFormat', 'SVF_Stressed',
    'Speech_Default_Weight', 'ISpObjectTokenCategory', 'SVP_21',
    'DISPID_SOTCDefault', 'ISpeechBaseStream', 'SPAUDIOSTATE',
    'DISPID_SRCEInterference', 'ISpRecognizer',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SGRSAddWordTransition',
    'SDTAudio', 'ISpeechGrammarRule', 'DISPID_SRCCreateGrammar',
    'SPEI_VISEME', 'DISPID_SpeechGrammarRules', 'DISPID_SLPsItem',
    'SPPS_Noncontent', 'SVESentenceBoundary',
    'DISPID_SABIMinNotification', 'ISpeechXMLRecoResult',
    'SPSHORTCUTTYPE', 'SPRECOSTATE', 'SREBookmark',
    'ISpeechPhraseElement', 'DISPID_SWFEChannels', 'SASClosed',
    'SDTReplacement', 'ISpeechLexicon', 'SVSFParseSapi', 'SVPNormal',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SBSRead',
    'DISPID_SPAsItem', 'DISPID_SCSBaseStream', 'DISPID_SVVolume',
    'SPEI_RESERVED5', 'DISPID_SRRPhraseInfo', 'SPEI_RESERVED6',
    'SpeechRuleState', 'SVF_Emphasis', 'SASStop',
    ...
    'SPSModifier', 'DISPID_SRCEEnginePrivate', 'DISPID_SASState',
    'SDA_No_Trailing_Space', 'DISPID_SRGCommit',
    'SpeechPropertyResponseSpeed', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPGS_ENABLED', 'SINoSignal', 'DISPID_SpeechRecoResult2',
    'DISPID_SGRSTNextState', 'DISPID_SPPs_NewEnum', 'SpStream',
    'DISPID_SVSRunningState', 'SAFT8kHz8BitMono', 'DISPID_SRCState',
    'SpInprocRecognizer', 'SPEI_TTS_AUDIO_LEVEL',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SpeechDataKey',
    'SGRSTTDictation', 'DISPID_SPEDisplayText', 'SPSERIALIZEDRESULT',
    ...
    'SpTextSelectionInformation', 'ISpeechGrammarRules',
    'SGSExclusive', 'SAFT16kHz16BitMono', 'SPPS_SuppressWord',
    'DISPID_SRRecognizer', 'STCLocalServer', 'SVP_7', 'SVP_0',
    'ISpeechFileStream', 'ISpeechPhraseProperty',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SRGId', 'SVP_13', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SVGetAudioInputs', 'SVSFIsXML', 'SPPS_Verb',
    'DISPID_SRCEHypothesis', 'DISPID_SLWLangId',
    'SPEI_START_INPUT_STREAM', 'SpeechStreamFileMode',
    'DISPID_SOTCId', 'DISPID_SOTIsUISupported',
    'ISpeechPhraseReplacements', 'eWORDTYPE_DELETED',
    'SECFIgnoreCase', 'SVPAlert', 'DISPID_SVEEnginePrivate',
    'SAFT8kHz16BitMono', 'SPPS_Noun', 'DISPID_SRGRecoContext',
    'SpeechRecognizerState', 'SPEI_SR_RETAINEDAUDIO', 'SPEI_MIN_SR',
    'SREStreamStart', 'ISpeechLexiconWord', 'SPEI_MIN_TTS',
    'SPEI_HYPOTHESIS', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SPIProperties', 'SpeechPropertyHighConfidenceThreshold',
    'SPSHT_NotOverriden', 'SAFTCCITT_uLaw_22kHzStereo',
    'tagSPPROPERTYINFO', 'SREStateChange',
    'SpeechEmulationCompareFlags', 'SVEPrivate', 'DISPID_SLWType',
    'DISPID_SVSLastBookmarkId', 'SRSActive', 'DISPID_SOTDataKey',
    'SVP_19', 'SAFT48kHz8BitMono', 'SpeechAudioFormatGUIDText',
    'SVP_10', 'DISPID_SRCEAudioLevel', 'SAFTCCITT_ALaw_44kHzMono',
    'SAFTADPCM_44kHzMono', 'SPEI_RECO_OTHER_CONTEXT',
    'ISpRecoContext', 'SPPHRASEPROPERTY',
    'ISpeechGrammarRuleStateTransitions', 'SAFT12kHz8BitMono',
    'SPEI_RESERVED1', 'SPAS_STOP', 'DISPID_SAVolume',
    'DISPID_SVResume', 'DISPID_SLWPronunciations',
    'SPFM_OPEN_READONLY', 'DISPID_SGRSTPropertyValue',
    'SAFTADPCM_8kHzMono', 'SITooFast', 'SpeechMicTraining', 'SASRun',
    'ISpRecoResult', 'SPRS_ACTIVE', 'SPSMF_UPS', 'ISpeechPhraseRule',
    'SREStreamEnd', 'ISpeechPhraseReplacement',
    'DISPID_SRSSupportedLanguages', 'SECFNoSpecialChars',
    'DISPID_SVEStreamEnd', 'DISPID_SRGState', 'DISPID_SFSClose',
    'SBOPause', 'SPEI_END_INPUT_STREAM', 'SP_VISEME_13',
    'SRTExtendableParse', 'DISPID_SRCEBookmark',
    'DISPID_SRGetPropertyNumber', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SAFType', 'ISpeechPhoneConverter',
    ...
    'SDTRule', 'DISPID_SOTGetStorageFileName', 'ISpPhrase',
    'SAFT22kHz16BitStereo', 'SpeechRegistryLocalMachineRoot',
    'SPPS_Function', 'SRSInactive', 'DISPID_SDKEnumKeys',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SpeechPhraseElement',
    'SSFMOpenReadWrite', 'DISPID_SRCEFalseRecognition',
    'DISPID_SDKSetLongValue', 'DISPID_SWFEFormatTag',
    'DISPID_SPEs_NewEnum', 'DISPID_SGRsFindRule', 'SPEVENT',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SVEVoiceChange',
    'DISPID_SpeechPhraseInfo', 'DISPID_SLGenerationId',
    'STSF_AppData', 'DISPID_SOTCGetDataKey', 'SP_VISEME_15',
    'SRERequestUI', 'SPWORDPRONUNCIATION', 'SpeechAllElements',
    'SpeechRecoContextState', 'DISPID_SREmulateRecognition',
    'DISPID_SGRSTText', 'DISPID_SRRTStreamTime', 'ISpRecognizer2',
    'SRTSMLTimeout', 'DISPID_SLPType', 'DISPID_SLGetPronunciations',
    'DISPID_SLGetWords', 'SDA_Two_Trailing_Spaces',
    'ISpeechMemoryStream', 'SpPhoneticAlphabetConverter',
    'SAFTADPCM_11kHzMono', 'SpeechTokenContext',
    'SPINTERFERENCE_NONE', 'SVP_12', 'SPXMLRESULTOPTIONS',
    'ISpeechAudioFormat', 'SpResourceManager', 'DISPID_SGRsCommit',
    'SGRSTTRule', 'SAFTGSM610_11kHzMono', 'DISPID_SMSALineId',
    'SVEBookmark', 'ISpObjectWithToken', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SPIGetDisplayAttributes', 'SRAExport',
    'SpSharedRecoContext', 'ISpeechRecoResult2',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SLGetGenerationChange', 'SVEViseme', 'DISPID_SPPName',
    'SPDKL_LocalMachine', 'DISPID_SpeechFileStream',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPLO_STATIC',
    'DISPID_SRAudioInput', 'DISPID_SVSInputWordPosition',
    'SWTDeleted', 'DISPID_SGRSTPropertyId', 'eLEXTYPE_RESERVED6',
    'ISpObjectToken', 'DISPID_SpeechPhraseElements',
    ...
    'SpStreamFormatConverter', 'DISPID_SVSLastBookmark',
    'ISpeechRecoResult', 'DISPID_SVSLastResult', 'DISPID_SPEsItem',
    'ISpeechPhraseProperties', 'SAFTADPCM_44kHzStereo',
    'DISPID_SPIRetainedSizeBytes', 'STCAll', 'ISpeechDataKey',
    'DISPID_SpeechAudioBufferInfo', 'eLEXTYPE_PRIVATE9',
    ...
    'SVSFIsFilename', 'SP_VISEME_4', 'SAFT8kHz16BitStereo',
    'SREAudioLevel', 'Speech_Max_Pron_Length',
    'DISPID_SRCEPhraseStart', 'SPEI_MAX_SR', 'DISPID_SRRAudioFormat',
    'DISPID_SPRuleId', 'SPRST_ACTIVE_ALWAYS', 'DISPID_SLPs_NewEnum',
    'SP_VISEME_19', 'DISPID_SpeechPhraseReplacements',
    'SAFTCCITT_ALaw_8kHzMono', 'SPEI_RESERVED3',
    'SpeechRecognitionType', 'DISPID_SDKDeleteValue',
    'SAFTGSM610_22kHzMono', 'SPSHT_OTHER', 'DISPID_SPRsItem',
    'DISPID_SRCRequestedUIType', 'DISPID_SPERequiredConfidence',
    'SPBO_AHEAD', 'WAVEFORMATEX',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRSClsidEngine', 'DISPID_SPRulesItem',
    'DISPID_SRSetPropertyNumber', 'SGDSActiveWithAutoPause',
    'SVSFNLPMask', 'SPSFunction', 'SAFT24kHz8BitStereo',
    'SpeechDiscardType', 'DISPID_SRAudioInputStream', 'SP_VISEME_7',
    'eLEXTYPE_PRIVATE18', 'DISPID_SOTSetId', 'DISPID_SADefaultFormat',
    'SAFTNonStandardFormat', 'DISPID_SAFSetWaveFormatEx',
    'SpeechVoiceEvents', 'SAFT44kHz8BitStereo',
    'DISPID_SRRDiscardResultInfo', 'SP_VISEME_10',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SRCBookmark',
    'DISPID_SPPParent', 'DISPID_SRCEPropertyNumberChange',
    'ISpGrammarBuilder', 'SpeechLoadOption', 'SVP_4',
    'ISpeechCustomStream', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SpeechPhraseAlternate', 'SVP_2', 'ISpeechObjectToken',
    'SPEI_REQUEST_UI', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SRRSpeakAudio', 'DISPID_SPRsCount', 'SpMMAudioIn',
    'SPWT_DISPLAY', 'ISpRecoContext2', 'SPEI_MAX_TTS',
    'SPCATEGORYTYPE', 'DISPID_SpeechLexiconWord',
    'DISPID_SRGSetTextSelection', 'eLEXTYPE_USER_SHORTCUT',
    'SVSFPersistXML', 'SpeechVoiceCategoryTTSRate', 'SPVPRI_ALERT',
    'DISPID_SRGCmdLoadFromResource', 'SpCompressedLexicon',
    'ISpPhraseAlt', 'STCInprocServer', 'SAFTCCITT_uLaw_44kHzMono',
    'STCInprocHandler', 'ISpPhoneConverter', 'SVSFNLPSpeakPunc',
    'DISPID_SpeechLexiconWords', 'DISPID_SVSPhonemeId',
    'SP_VISEME_12', 'SPRECOCONTEXTSTATUS', 'eWORDTYPE_ADDED',
    'SPWORD', 'DISPID_SRCCreateResultFromMemory',
    'ISpeechAudioStatus', 'SAFT24kHz16BitStereo', 'ISpMMSysAudio',
    'SPEI_VOICE_CHANGE', 'STCRemoteServer', 'SPLO_DYNAMIC',
    ...
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SMSSetData',
    'IInternetSecurityManager', 'SAFTADPCM_22kHzMono', 'SP_VISEME_16',
    'SFTSREngine', 'DISPID_SVEWord', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRCRecognizer', 'DISPID_SpeechPhraseRules',
    'DISPID_SVSCurrentStreamNumber', 'SVEVoiceChange', 'SVSFDefault',
    'SPAUDIOBUFFERINFO', 'DISPID_SPANumberOfElementsInResult',
    'SPAR_Medium', 'SDTDisplayText', 'DISPID_SRRRecoContext',
    'SRESoundEnd', 'SPAR_Low', 'SPRECOGNIZERSTATUS',
    'ISpStreamFormatConverter', 'SPTEXTSELECTIONINFO',
    'SPEI_SOUND_START', 'SVSFlagsAsync', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SPISaveToMemory', 'ISpeechWaveFormatEx', 'SP_VISEME_18',
    'SpeechVoicePriority', 'DISPID_SVSVisemeId', 'SVEEndInputStream',
    'SPGS_DISABLED', 'SAFTADPCM_22kHzStereo', 'SP_VISEME_6',
    'ISpLexicon', 'SREAllEvents', 'SPCT_SLEEP', 'SREFalseRecognition',
    'IEnumString', 'SPCT_SUB_DICTATION', 'SVEAudioLevel',
    'SpUnCompressedLexicon', 'DISPID_SAFGetWaveFormatEx',
    'ISpStreamFormat', 'DISPID_SPRuleChildren',
    'SpeechDictationTopicSpelling', 'SP_VISEME_11',
    'SDTPronunciation', 'SpeechCategoryRecognizers',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SOTCreateInstance',
    'SPCT_SUB_COMMAND', 'DISPID_SLPLangId', 'DISPID_SPAPhraseInfo',
    'SpeechTokenKeyUI', 'SPAS_RUN', 'ISpXMLRecoResult',
    'ISpSerializeState', 'DISPID_SDKSetStringValue', 'SINoise',
    'DISPID_SASCurrentDevicePosition', 'ISpEventSource',
    'DISPID_SLWs_NewEnum', 'DISPID_SRProfile', 'SAFT44kHz16BitStereo',
    'SpeechCategoryPhoneConverters', 'DISPIDSPTSI_ActiveLength',
    'SRAInterpreter', 'DISPID_SVPause', 'SAFTExtendedAudioFormat',
    'SVP_18', 'SpeechUserTraining', 'SRAONone', 'SVSFParseSsml',
    'SAFT22kHz8BitStereo', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SGRsDynamic', 'ISpeechResourceLoader',
    'DISPID_SVAudioOutput', 'SRSEDone', 'SAFTCCITT_ALaw_8kHzStereo',
    'ISpeechGrammarRuleState', 'SVP_3', 'eLEXTYPE_USER',
    'SAFT22kHz8BitMono', 'SpeechGrammarTagUnlimitedDictation',
    'SECHighConfidence', 'SpeechPropertyResourceUsage',
    'SAFT22kHz16BitMono', 'DISPID_SLWsCount', 'ISpNotifyTranslator',
    'SAFTText', 'SpeechCategoryVoices', 'SPEI_START_SR_STREAM',
    '_ISpeechRecoContextEvents', 'SRSActiveAlways',
    'DISPID_SMSADeviceId', 'SAFTDefault', 'SpeechWordType',
    'DISPID_SPRuleParent', 'STSF_LocalAppData', 'SBONone',
    'DISPID_SpeechAudio', 'DISPID_SOTCSetId',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SBSSeek',
    'SPEI_PROPERTY_STRING_CHANGE', 'SDA_Consume_Leading_Spaces',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SGRSAddSpecialTransition',
    'SPEI_TTS_PRIVATE', 'SP_VISEME_2', 'SLTUser', 'SPAS_CLOSED',
    'DISPID_SOTs_NewEnum', 'IStream', 'SAFT32kHz16BitMono',
    'SpeechTokenShellFolder', 'DISPID_SGRSTsItem', 'ISpNotifySource',
    ...
    'SpeechRetainedAudioOptions', 'SITooSlow', 'SPSHT_Unknown',
    'SPWT_LEXICAL', 'SRTAutopause', 'SpNullPhoneConverter',
    'SpeechAudioFormatType', 'SRARoot', 'SPWT_PRONUNCIATION',
    'SPSHT_EMAIL', 'DISPID_SPPValue', 'SVSFUnusedFlags',
    'eLEXTYPE_PRIVATE16', 'SPLEXICONTYPE', 'DISPID_SAEventHandle',
    ...
    'DISPID_SVEViseme', 'DISPID_SVIsUISupported',
    'SPFM_OPEN_READWRITE', 'ISpeechPhraseAlternate',
    'ISpeechVoiceStatus', 'SAFT32kHz16BitStereo', 'DISPID_SMSGetData',
    'DISPID_SPILanguageId', 'SAFT48kHz16BitMono', 'ISpeechPhraseInfo',
    'DISPID_SRGetPropertyString', 'DISPID_SRCreateRecoContext',
    'SP_VISEME_9', 'SpWaveFormatEx', 'DISPID_SASFreeBufferSpace',
    'SpeechVisemeFeature', 'ISpEventSink', 'DISPID_SAStatus',
    'SPCT_COMMAND', 'SpPhoneConverter',
    'DISPID_SPRuleNumberOfElements', 'SP_VISEME_3',
    'SPGRAMMARWORDTYPE', 'DISPID_SRStatus', 'SVP_11', 'ISpProperties',
    'SAFTNoAssignedFormat', 'SpeechTokenKeyFiles',
    'Speech_StreamPos_RealTime', 'DISPID_SRGReset', 'SVEPhoneme',
    'DISPID_SPRulesCount', 'SPAO_RETAIN_AUDIO', 'DISPID_SRRTLength',
    'SSTTDictation', 'DISPID_SRSAudioStatus', 'SREHypothesis',
    'eLEXTYPE_PRIVATE20', 'SpeechPropertyNormalConfidenceThreshold',
    'SPEI_FALSE_RECOGNITION', 'STSF_FlagCreate', 'SPWF_INPUT',
    'DISPID_SGRSTWeight', 'DISPID_SPIStartTime', 'SPCS_DISABLED',
    'SpMMAudioEnum', 'SPSInterjection', 'ISpeechRecoGrammar',
    'SP_VISEME_1', 'SGLexical', 'SVF_None', 'SPFM_NUM_MODES',
    'DISPID_SpeechGrammarRule', 'DISPID_SpeechVoice', 'SITooLoud',
    'ISpeechAudioBufferInfo', 'DISPID_SLRemovePronunciation',
    'SLOStatic', 'eLEXTYPE_PRIVATE1', 'ISpeechPhraseElements',
    'DISPID_SWFEAvgBytesPerSec', 'SVP_15', 'DISPID_SASNonBlockingIO',
    'SPINTERFERENCE_NOISE', 'SpeechPropertyAdaptationOn',
    'SPEI_RESERVED2', 'SPLOADOPTIONS', 'SREPropertyStringChange',
    'SGRSTTWildcard', 'DISPID_SOTMatchesAttributes',
    'DISPID_SRCEAdaptation', 'SPVPRIORITY',
    'ISpeechPhraseInfoBuilder', 'SpeechStreamSeekPositionType',
    'DISPID_SGRsAdd', 'DISPID_SPRNumberOfElements',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SRCESoundEnd',
    'SSFMCreateForWrite', 'SREAdaptation',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SPCLangId',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRCEEndStream',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SpeechLexiconPronunciation',
    'SPBOOKMARKOPTIONS', 'DISPID_SASetState',
    'DISPID_SVSInputSentencePosition', 'SPRECORESULTTIMES',
    'DISPID_SOTsItem', 'DISPID_SLPPhoneIds', 'SRCS_Enabled',
    'SPPS_RESERVED3', 'eLEXTYPE_PRIVATE2', 'SPPHRASEREPLACEMENT',
    'SPWF_SRENGINE', 'SAFTADPCM_11kHzStereo', 'DISPID_SGRSTsCount',
    'SPPS_Interjection', 'DISPID_SPRText', 'SPEI_RECOGNITION',
    'SpAudioFormat', 'eLEXTYPE_PRIVATE6', 'SPAS_PAUSE',
    'SSSPTRelativeToEnd', 'SAFT11kHz16BitStereo',
    'SVSFPurgeBeforeSpeak', 'SVP_14', 'DISPID_SVGetVoices',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SPIRule',
    'DISPID_SPIReplacements', 'DISPID_SVSInputSentenceLength',
    'SP_VISEME_0', 'SVSFParseMask', 'SPWORDTYPE', 'SREInterference',
    'DISPID_SPPEngineConfidence', 'SpeechAudioVolume',
    'DISPID_SWFESamplesPerSec', 'SpInProcRecoContext',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SGRSTType', 'SPVOICESTATUS',
    'DISPID_SRCEStartStream', 'SAFTADPCM_8kHzStereo',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SVSpeak', 'SSTTWildcard',
    'SPWAVEFORMATTYPE', 'ISpeechObjectTokens', 'SPPHRASE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SGRAddState',
    'SRESoundStart', 'eLEXTYPE_PRIVATE19',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SMSAMMHandle', 'LONG_PTR',
    'SRSEIsSpeaking', 'SRAImport', 'SPEI_SENTENCE_BOUNDARY',
    'SREPropertyNumChange', 'ISpVoice', 'SGDSActiveUserDelimited',
    'SPINTERFERENCE_TOOLOUD', 'SVP_1', 'ISpeechPhraseRules',
    'DISPID_SRGCmdLoadFromFile', 'ISpeechRecoResultDispatch',
    'SPPS_Unknown', 'DISPID_SGRClear', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SPRuleConfidence',
    'DISPID_SPRs_NewEnum', 'SpNotifyTranslator',
    'SpeechBookmarkOptions', 'SITooQuiet', 'DISPID_SLPSymbolic',
    'SpeechDataKeyLocation', 'IInternetSecurityMgrSite', 'SLTApp',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SWFEBitsPerSample',
    'DISPID_SBSFormat', 'SPWORDPRONOUNCEABLE', 'DISPID_SRCERequestUI',
    'SPPS_LMA', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SAFGuid', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SVESentenceBoundary', 'SpeechGrammarWordType', 'SFTInput',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SGRsItem',
    'SPEI_WORD_BOUNDARY', 'SINone', 'ISpeechRecognizer',
    'ISpNotifySink', 'DISPID_SpeechRecoResult', 'SPEI_END_SR_STREAM',
    'SPPS_RESERVED1', 'DISPID_SpeechObjectTokenCategory',
    'SpShortcut', 'DISPID_SRCAudioInInterferenceStatus',
    '_ISpeechVoiceEvents', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SVSyncronousSpeakTimeout', 'SPRST_NUM_STATES', 'SVP_17',
    'SPCS_ENABLED', 'SPEI_SR_AUDIO_LEVEL', 'DISPID_SRRAlternates',
    'DISPID_SpeechAudioStatus', 'DISPID_SpeechPhraseProperties',
    'SPSUnknown', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SRCRetainedAudioFormat', 'SpeechTokenKeyAttributes',
    'ISpRecoGrammar2', 'DISPID_SpeechObjectToken',
    'Speech_StreamPos_Asap', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SGRSTPropertyName', 'DISPID_SWFEExtraData',
    'DISPID_SPPConfidence', 'SRCS_Disabled', 'SAFT12kHz16BitMono',
    'eLEXTYPE_RESERVED10', 'SRADefaultToActive', 'SAFT24kHz16BitMono',
    'SPADAPTATIONRELEVANCE', 'SPSHORTCUTPAIR', 'SpeechFormatType',
    'SSFMCreate', 'SpMMAudioOut', 'SpeechTokenValueCLSID',
    'SpeechAudioProperties', 'SPPROPERTYINFO', 'SECFDefault',
    'SPRULESTATE', 'SVSFParseAutodetect', 'DISPID_SVEventInterests',
    'DISPID_SpeechVoiceStatus', 'SGRSTTTextBuffer', 'SPAO_NONE',
    'DISPID_SLWsItem', 'SPSHORTCUTPAIRLIST', 'SpeechRecoEvents',
    'DISPID_SRSCurrentStreamNumber', 'SPSEMANTICFORMAT',
    'DISPID_SPAsCount', 'SASPause', 'SpeechWordPronounceable',
    'SVSFVoiceMask', 'eLEXTYPE_PRIVATE12', 'DISPID_SPIElements',
    'ISpeechTextSelectionInformation', 'DISPID_SpeechLexicon',
    'DISPID_SGRSRule', 'SAFT11kHz8BitMono',
    'SAFTCCITT_uLaw_22kHzMono', 'SpeechLexiconType',
    'DISPID_SRGRules', 'DISPID_SRRTTickCount', 'SP_VISEME_5',
    'SPXRO_SML', 'SPEI_SR_PRIVATE', 'SpSharedRecognizer',
    'SPPS_Modifier', 'eLEXTYPE_RESERVED8', 'SP_VISEME_17',
    'SP_VISEME_21', 'SWPUnknownWordUnpronounceable',
    'DISPID_SpeechObjectTokens', 'tagSTATSTG',
    'DISPID_SPPNumberOfElements', 'DISPID_SRIsShared',
    'DISPID_SRGDictationUnload', 'SAFT8kHz8BitStereo',
    'SPEI_SR_BOOKMARK', 'DISPID_SRCSetAdaptationData',
    'ISpRecoGrammar', 'SAFT32kHz8BitMono',
    'DISPID_SRRSetTextFeedback', 'DISPID_SRIsUISupported',
    'DISPID_SDKGetBinaryValue', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SLPPartOfSpeech', 'DISPID_SVGetAudioOutputs',
    'eLEXTYPE_MORPHOLOGY', 'SpeechVoiceSpeakFlags', 'SpeechRunState',
    'DISPID_SOTGetAttribute', 'DISPID_SGRName', 'ISpDataKey',
    'DISPID_SPPsCount', 'SREPrivate', 'SPBINARYGRAMMAR',
    'DISPID_SPEActualConfidence', 'SP_VISEME_20',
    'SDKLDefaultLocation', '__MIDL_IWinTypes_0009',
    'DISPID_SVSpeakStream', 'SpeechVisemeType', 'SSTTTextBuffer',
    'DISPID_SVEPhoneme', 'SPEVENTENUM', 'DISPID_SPRules_NewEnum',
    '_RemotableHandle', 'SPFILEMODE', 'DISPID_SVEBookmark',
    'SAFT44kHz8BitMono', 'DISPIDSPTSI', 'DISPID_SVPriority',
    'DISPID_SGRsCount', 'DISPID_SRState', 'SAFT12kHz16BitStereo',
    'DISPID_SGRSTransitions', 'DISPID_SpeechPhraseProperty',
    'SPEVENTSOURCEINFO', 'DISPID_SpeechRecoContextEvents',
    'SPCT_DICTATION', 'eLEXTYPE_PRIVATE8', 'eLEXTYPE_PRIVATE11',
    'SAFTGSM610_44kHzMono', 'SpeechAudioState', 'DISPID_SVDisplayUI',
    'DISPID_SRGDictationLoad', 'SPRULE', 'SpPhraseInfoBuilder',
    'DISPID_SGRAddResource', 'SRTStandard', 'DISPID_SPELexicalForm',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SpeechCustomStream', 'SVP_9',
    'DISPID_SRSetPropertyString', 'DISPID_SGRInitialState',
    'SAFT32kHz8BitStereo', 'DISPID_SPIEnginePrivateData',
    'DISPID_SPEAudioStreamOffset', 'SPRST_INACTIVE',
    'SpeechCategoryAppLexicons', 'SPINTERFERENCE_TOOSLOW',
    'SECLowConfidence', 'DISPID_SWFEBlockAlign', 'SPAUDIOSTATUS',
    'SRSInactiveWithPurge', 'DISPID_SPPId', 'eLEXTYPE_RESERVED4',
    'SDKLCurrentUser', 'ISequentialStream', 'DISPID_SVStatus',
    'SpeechGrammarRuleStateTransitionType', 'SAFT48kHz16BitStereo',
    'SPEI_ADAPTATION', 'DISPID_SPEAudioSizeTime',
    'SpObjectTokenCategory', 'SpeechEngineConfidence',
    'SPEI_TTS_BOOKMARK', 'SDA_One_Trailing_Space', 'SpMemoryStream',
    'SpObjectToken', 'SAFT16kHz8BitStereo',
    'SpeechGrammarTagWildcard',
    'DISPID_SRCERecognitionForOtherContext', '_SPAUDIOSTATE',
    'SP_VISEME_8', 'SPSLMA', 'SDKLLocalMachine', 'SRATopLevel',
    ...
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SVP_20', 'SPPS_RESERVED2',
    'SpCustomStream', 'SpFileStream', 'DISPID_SABIEventBias',
    'SAFTCCITT_uLaw_11kHzMono', 'SVP_6', 'DISPID_SRCPause',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SpeechLexiconProns',
    'DISPIDSPRG', 'DISPID_SOTId', 'DISPID_SPIEngineId',
    'SPSEMANTICERRORINFO', 'DISPID_SPACommit',
    'SPDKL_DefaultLocation', 'SpeechInterference',
    'SpeechCategoryAudioOut', 'SPSNotOverriden', 'SPAUDIOOPTIONS',
    'DISPID_SABufferInfo', 'eLEXTYPE_PRIVATE10',
    'DISPID_SABufferNotifySize', 'DISPID_SGRSTRule',
    'SAFT16kHz8BitMono', 'DISPID_SpeechRecoContext',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SPCPhoneToId',
    'DISPID_SRRAudio', 'DISPID_SPERetainedSizeBytes',
    'SpeechTokenIdUserLexicon', 'DISPID_SDKSetBinaryValue',
    'DISPID_SLAddPronunciation', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SGLexicalNoSpecialChars', 'SPINTERFERENCE', 'DISPID_SPIGetText',
    'DISPID_SPRuleName', 'SECFIgnoreWidth', 'DISPID_SGRAttributes',
    'DISPID_SOTsCount', 'SPPS_RESERVED4', 'SRAORetainAudio',
    'DISPID_SpeechVoiceEvent', 'SVP_5', 'SPAR_Unknown', 'SVP_16',
    'DISPID_SDKCreateKey', 'SGDisplay', 'DISPID_SFSOpen',
    'SPFM_CREATE', 'SGRSTTEpsilon', 'SAFTGSM610_8kHzMono',
    'DISPID_SpeechMMSysAudio', 'DISPID_SPPFirstElement', 'ISpAudio',
    'DISPID_SPARecoResult', 'SpeechDisplayAttributes',
    'SPPARTOFSPEECH', 'SPEI_UNDEFINED', 'UINT_PTR', 'SDTProperty',
    'DISPID_SPAStartElementInResult', 'SAFT12kHz8BitStereo',
    'DISPID_SpeechPhraseRule', 'DISPID_SASCurrentSeekPosition',
    'SGRSTTWord', 'DISPID_SPEEngineConfidence', 'SPGRAMMARSTATE',
    'SAFT44kHz16BitMono', 'ISpRecognizer3', 'SVP_8', 'SRTEmulated',
    'SRTReSent', 'SpeechPartOfSpeech', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'ISpeechAudio', 'DISPID_SBSWrite', 'SPPS_NotOverriden',
    'ISpeechRecoResultTimes', 'IEnumSpObjectTokens',
    'eLEXTYPE_PRIVATE13', 'SPDKL_CurrentConfig', 'SpeechGrammarState',
    'DISPID_SGRsCommitAndSave', 'DISPID_SpeechBaseStream',
    'DISPID_SPIAudioStreamPosition', 'SDKLCurrentConfig',
    'SRERecoOtherContext', 'DISPID_SDKEnumValues',
    'ISpResourceManager', 'Speech_Max_Word_Length', 'DISPID_SRRTimes',
    'DISPID_SPRFirstElement', 'SPEI_SOUND_END', 'eLEXTYPE_APP',
    'ISpeechPhraseAlternates', 'DISPID_SRCRetainedAudio',
    'DISPID_SGRSTs_NewEnum', 'SDTAll', 'eLEXTYPE_PRIVATE3',
